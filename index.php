...
</v-container><v-container v-if="viewmode=='about'">
    <v-row>
        <v-col class="mx-auto">
...
</v-container><v-container v-if="viewmode=='account'" id="account">
    <v-row>
...
</v-container><v-container v-if="viewmode=='flist'">
    <v-row>
        <v-col class="mx-auto">
            <v-row>
...
</v-container><v-container v-if="viewmode=='forum'">
    <v-row>
        <v-col cols="12">
...
</v-container><v-container v-if="viewmode=='index'" id="index">
    <v-row>
        <v-col cols="12">
            <div>
...
</v-container><v-container v-if="viewmode=='message'">
    <v-row>
...
</v-container><v-container v-if="viewmode=='myitem'">
    <v-row>
        <v-col class="mx-auto">
            <v-row>
                <v-col cols="12" md="6">
...
</v-container><v-container v-if="viewmode=='mywork'">
    <v-row>
        <template>
            <v-col class="" cols="12">
...
</v-container><v-container v-if="viewmode=='post'">
    <v-row>
        <v-col cols="12">
            <v-breadcrumbs
...
</v-container><v-container v-if="viewmode=='search'" id="search">
    <v-row>
...
</v-container><v-container v-if="viewmode=='sign'" id="sign">
    <v-row>
        <v-col class="mx-auto" cols="12" md="6">
...
</v-container><v-container v-if="viewmode=='studio'">
    <v-row>
...
</v-container><v-container v-if="viewmode=='studio_edit'">
    <v-row>
...
</v-container><v-container v-if="viewmode=='user'">
    <v-row>
...
</v-container><v-container v-if="viewmode=='work'">
    <v-row>
        <template>
...
</v-container><v-container v-if="viewmode=='workinfo'">
    <v-row>
        <v-col class="mx-auto" cols="12" md="6">
